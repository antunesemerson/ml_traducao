...
RULE_VERSION = "culture_religion_parameter_modifier_batch8_learning_ingest_v1"
QUEUE_SOURCE = "culture-religion-parameter-modifier-human-review-batch8"
ORIGIN = "human_confirmed_culture_religion_parameter_modifier_batch8"
MATCH_TYPE_ALREADY_OK = "culture_religion_parameter_modifier_human_confirmed_already_ok"
REVIEWER = "user_human_review_culture_religion_parameter_modifier_batch8"
FOCUS_GROUP = "culture_religion_parameter_modifier_batch8"
...
HOLD_SEGMENT_IDS = {
    21157: "correction hold: Spanish residual '#v jurar lealtad#!'",
    20631: "context hold: sentence appears truncated around '[ruler|lE]'",
    20697: "context hold: phrasing appears incomplete around success chance",
    240260: "review hold: doctrine term/article agreement needs confirmation",
}
...
def insert_candidate(conn, run_id: int, context, sample_row: dict[str, Any], timestamp: str) -> int:
    ...
    reasons = [
        "human_confirmed_culture_religion_parameter_modifier_batch8",
    ...
    cursor = conn.execute(
        ...
        (
            ...
            "high_confidence",
            "correct",
            "human-approved culture/religion parameter modifier batch8 already-ok signal",
            REVIEWER,
            timestamp,
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_culture_religion_parameter_modifier_batch8_learning_ingest"
    ...
    lines = [
        "culture/religion parameter modifier batch8 learning ingest",
...
def main() -> None:
    ...
    summary = {
        ...
        "next_action": "apply_local_learning_feedback_for_culture_religion_parameter_modifier_batch8",
    }
