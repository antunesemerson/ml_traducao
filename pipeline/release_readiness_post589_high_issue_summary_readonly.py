...
SOURCE = "release_readiness_post589_high_issue_summary_readonly_v1"
DEFAULT_READINESS_SUMMARY = Path("reports/20260703_220533_670568_release_readiness_post544_diagnostic_summary.json")
DEFAULT_READINESS_JSONL = Path("reports/20260703_220533_670568_release_readiness_post544_diagnostic.jsonl")
DEFAULT_DELTAS = [
...
PROCESSED_OR_HOLD_IDS = {
    ...
    77508, 30353, 32275, 32460, 32724, 32951, 33009, 34000, 34575, 34576, 36405, 36599, 42215, 42294,
    42312, 42468, 42665, 43126, 43127, 45147, 45357, 47386, 47758, 48006, 50923, 52456, 55152, 55344,
    58171, 58673,
...
def main() -> None:
    ...
    summary = {
        "schema_version": 1,
        "source": SOURCE,
        "mode": "read_only_post589_release_readiness_summary",
    ...
    base = reports_dir() / f"{stamp()}_release_readiness_post589_high_issue_summary_readonly"
    ...
    md_path.write_text(
        "\n".join(
            [
                "# Release Readiness Post-589 Summary",
                "",
