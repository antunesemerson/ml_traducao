...
RULE_VERSION = "semantic_review_router_batch26_learning_ingest_v1"
QUEUE_SOURCE = "semantic-review-router-diverse-human-review-batch26"
ORIGIN = "human_confirmed_semantic_review_router_batch26"
MATCH_TYPE_ALREADY_OK = "semantic_review_router_diverse_human_confirmed_already_ok"
MATCH_TYPE_CORRECTION = "semantic_review_router_diverse_human_correction"
REVIEWER = "user_human_review_semantic_review_router_batch26"
FOCUS_GROUP = "semantic_review_router_diverse_batch26"
SEGMENT_STATE_RUN_ID = 455
...
APPROVED_CORRECTIONS = {
    38478: "Embora a capital desta personagem tenha sido devastada pela peste, ela está determinada a vê-la se recuperar.",
}

HOLD_SEGMENTS = {
    12385: "hold_sentence_fragment_needs_previous_context",
    31128: "hold_opening_quote_fragment_needs_previous_context",
    34096: "hold_sentence_fragment_needs_previous_context",
    34101: "hold_sentence_fragment_needs_previous_context",
}
...
def insert_candidate(conn, run_id: int, context, suggested: str, match_type: str, source_language: str, reason: str, timestamp: str) -> int:
    reasons = [
        RULE_VERSION,
        "semantic_review_router_diverse_policy_design",
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_semantic_review_router_batch26_learning_ingest"
    ...
    lines = [
        "semantic review router batch26 learning ingest",
            ...
            if not reasons:
                ...
                if existing:
                    ...
                    candidate_id = insert_candidate(
                        ...
                        "human_already_ok",
                        "human-approved semantic review router diverse already-ok signal",
                        timestamp,
                    )
                    inserted += 1
                    inserted_ok += 1
            ...
            if not reasons:
                ...
                if existing:
                    ...
                    candidate_id = insert_candidate(
                        ...
                        "human_correction",
                        "human-approved semantic review router diverse correction",
                        timestamp,
                    )
                    inserted += 1
