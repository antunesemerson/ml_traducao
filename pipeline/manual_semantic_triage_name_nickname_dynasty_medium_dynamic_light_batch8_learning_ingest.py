...
RULE_VERSION = "manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch8_learning_ingest_v1"
QUEUE_SOURCE = "manual-semantic-triage-name-nickname-dynasty-medium-dynamic-light-human-review-batch8"
ORIGIN = "human_confirmed_manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch8"
...
REVIEWER = "user_human_review_manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch8"
FOCUS_GROUP = "manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch8"
SEGMENT_STATE_RUN_ID = 481
...
APPROVED_CORRECTIONS = {
    120864: "Você decide não fazer isso. Adotar um [nickname|lE] infame certamente só serviria para frustrar seus esforços no futuro.",
    122116: "Você acredita que [disobedient_subject.GetFirstName] faria tudo o que estivesse ao seu alcance para concluir a tarefa",
    134631: "As chances de encontrar um livro melhor aumentam graças ao meu companheiro de viagem [sightseeing_companion.GetName]",
    134637: "As chances de encontrar um artefato melhor aumentam graças ao meu companheiro de viagem [sightseeing_companion.GetName]",
    164849: "Foi revelado que [spouse.GetFirstName] e eu estávamos em um casamento incestuoso, por causa de uma ama de leite compartilhada",
}

HELD_SEGMENT_IDS = [101655, 103124, 136461, 157259, 165081, 165334]
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch8_learning_ingest"
    ...
    lines = [
        "manual semantic triage name/nickname/dynasty medium dynamic light batch8 learning ingest",
