...
RULE_VERSION = "manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch3_learning_ingest_v1"
QUEUE_SOURCE = "manual-semantic-triage-name-nickname-dynasty-medium-dynamic-light-human-review-batch3"
ORIGIN = "human_confirmed_manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch3"
MATCH_TYPE_ALREADY_OK = "manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_human_confirmed_already_ok"
MATCH_TYPE_CORRECTION = "manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_human_correction"
REVIEWER = "user_human_review_manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch3"
FOCUS_GROUP = "manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch3"
SEGMENT_STATE_RUN_ID = 476
...
APPROVED_CORRECTIONS = {
    35670: "Magnatas voltados para a riqueza instam seus mestres a imitar seu famoso interesse em reformar a sociedade e o com\u00e9rcio [ROOT.Char.GetCulture.GetName].",
    35672: "Correm rumores por toda parte sobre as cerim\u00f4nias de seus sal\u00f5es sagrados, enquanto as pessoas especulam avidamente sobre a natureza dividida de sua alma [ROOT.Char.GetCulture.GetName].",
    44894: "\\n\\nO sol sobe mais alto no c\u00e9u, e as sombras se encurtam. Se eu for competir na competi\u00e7\u00e3o de [activity.GetCurrentPhase.GetPhase.GetName|l], preciso me certificar de que vou me classificar. Ela come\u00e7ar\u00e1 em breve.",
    45784: "Custo base do [GetActivityType( 'activity_tournament' ).GetName|l]",
    46219: "Resultados das quartas de final de [CHARACTER.GetInvolvedActivity.GetCurrentPhase.GetPhase.GetName|l]",
    46307: "Voc\u00ea est\u00e1 no caminho para se qualificar para a competi\u00e7\u00e3o de [THIS.Char.GetInvolvedActivity.GetCurrentPhase.GetPhase.GetName|l]",
    46310: "Voc\u00ea pode n\u00e3o se qualificar para a competi\u00e7\u00e3o de [THIS.Char.GetInvolvedActivity.GetCurrentPhase.GetPhase.GetName|l]",
}

HELD_SEGMENT_IDS = [12106, 44999]
...
def insert_candidate(conn, run_id: int, context, suggested: str, match_type: str, source_language: str, reason: str, timestamp: str) -> int:
    reasons = [
        RULE_VERSION,
        "manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light",
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch3_learning_ingest"
    ...
    lines = [
        "manual semantic triage name/nickname/dynasty medium dynamic light batch3 learning ingest",
