...
SOURCE = "release_decision_post594_extract_human_decisions_v1"
DEFAULT_MARKDOWN = Path("reports/20260704_111007_137039_release_decision_post594_corrected_text_human_packet.md")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Extract post594 human decisions and validate ready/hold split.")
...
def main() -> None:
    ...
    base = reports_dir() / f"{stamp()}_release_decision_post594_human_decision_extract"
    ...
    md_lines = [
        "# Post-594 Human Decision Extract",
        "",
        ...
        f"- ready_apply_ids: {ready_apply_ids}",
        f"- ready_approve_already_ok_ids: {ready_approve_ids}",
