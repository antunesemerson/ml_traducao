...
RULE_VERSION = "culture_religion_parameter_modifier_batch3_learning_ingest_v1"
QUEUE_SOURCE = "culture-religion-parameter-modifier-human-review-batch3"
ORIGIN = "human_confirmed_culture_religion_parameter_modifier_batch3"
MATCH_TYPE_ALREADY_OK = "culture_religion_parameter_modifier_human_confirmed_already_ok"
REVIEWER = "user_human_review_culture_religion_parameter_modifier_batch3"
FOCUS_GROUP = "culture_religion_parameter_modifier_batch3"
...
HOLD_SEGMENT_IDS = [20721, 21426, 239972]
SAMPLE_PATTERN = "*_culture_religion_parameter_modifier_batch2_readonly_sample.jsonl"
...
def latest_sample() -> Path:
    ...
    if not matches:
        raise SystemExit("missing batch2 read-only sample jsonl")
    return matches[0]
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_culture_religion_parameter_modifier_batch3_learning_ingest"
    ...
    lines = [
        "culture/religion parameter modifier batch3 learning ingest",
...
def main() -> None:
    ...
    summary = {
        ...
        "source_changed": False,
        "output_changed": False,
        "next_action": "apply_local_learning_feedback_for_culture_religion_parameter_modifier_batch3",
    }
