...
SOURCE = "domain_policy_vote_candidate_religion_faith_possessive_relation_policy_registry_v1"
AGENT_KEY = "religion_faith_doctrine_possessive_relation_policy"
...
REVIEW_SUMMARY_PATH = Path(
    "reports/20260630_111452_234839_domain_policy_vote_candidate_religion_faith_possessive_relation_review_summary.json"
)
REVIEW_JSONL_PATH = Path(
    "reports/20260630_111452_234839_domain_policy_vote_candidate_religion_faith_possessive_relation_review.jsonl"
)
EXPECTED_REVIEW_COUNT = 22
EXPECTED_SEGMENT_STATE_RUN_ID = 507
EXPECTED_COUNTS = {
    "faith_getter_person_possessive": 8,
    "family_war_relation_narrative": 4,
    "priest_relation_multiline_narrative": 3,
    "residual_possessive_relation_context": 2,
    "faith_getter_relation_context": 2,
    "multiline_relation_context": 1,
    "secret_or_crypto_faith_relation": 1,
    "light_relation_context": 1,
}
...
def choose_priority(conn: sqlite3.Connection) -> tuple[int, str]:
    ...
    while priority in used:
        priority += 1
    note = "priority_46_available" if priority == 46 else f"priority_46_conflict_used_{priority}"
...
def validate_inputs(summary: dict[str, Any], rows: list[dict[str, Any]]) -> dict[str, Any]:
    ...
    return {
        ...
        "parser_or_policy_count": int(summary.get("parser_or_policy_count") or 0),
...
def planned_record(validation: dict[str, Any], parent_validation: dict[str, Any], priority: int, priority_note: str) -> dict[str, Any]:
    route_subtypes = {
        "faith_getter_person_possessive": "route_perspective_relation_parser_review",
        "faith_getter_relation_context": "route_faith_relation_parser_review",
    }
    hold_subtypes = {
        "family_war_relation_narrative": "hold_family_war_relation_narrative",
        "priest_relation_multiline_narrative": "hold_priest_relation_multiline_narrative",
        "multiline_relation_context": "hold_multiline_relation_context",
        "secret_or_crypto_faith_relation": "hold_secret_or_crypto_faith_relation",
        "residual_possessive_relation_context": "hold_residual_possessive_relation_context",
        "light_relation_context": "small_human_review_later",
    }
    notes = {
        "source": SOURCE,
        ...
        "hold_family": "faith_possessive_or_relation",
        ...
        "parser_or_policy_count": int(validation["parser_or_policy_count"]),
        ...
        "policy_recommendation": (
            "Read-only splitter for faith possessive/relation surfaces. Route only perspective/faith-relation parser "
            "review surfaces; hold family-war, priest multiline, secret-faith, residual, and narrative contexts."
        ),
        "guards": {
    ...
    return {
        ...
        "decision_role": DECISION_ROLE,
        "scope_group": SCOPE_GROUP,
        "scope_description": "Read-only splitter for religion_faith_doctrine faith possessive/relation surfaces.",
        "dashboard_group": DASHBOARD_GROUP,
        "priority": priority,
        "notes_json": notes,
    }
...
def validate_registry(conn: sqlite3.Connection) -> dict[str, Any]:
    ...
    return {
        ...
        "parser_or_policy_count": notes.get("parser_or_policy_count"),
    }
...
def write_reports(
    *,
    ...
    lines = [
        "religion_faith_doctrine possessive/relation policy registry",
        "",
        f"mode: {mode}",
