...
SOURCE = "short_label_light_token_post_learning_status_v1"
LEARNING_RUN_IDS = (699,)
KNOWN_HOLDS = {
...
def build_summary() -> dict[str, Any]:
    ...
    latest_review_packet = latest_file("*_short_label_light_token_guarded_review_packet_summary.json")
    ...
    next_action = (
        "run_segment_state_only_to_measure_short_label_light_token_learning_delta"
...
def write_outputs(summary: dict[str, Any]) -> tuple[Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_short_label_light_token_post_learning_status"
    ...
    lines = [
        "short label light-token post learning status",
        f"source={SOURCE}",
