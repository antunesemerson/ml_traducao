...
RULE_VERSION = "culture_religion_parameter_modifier_batch12_learning_ingest_v1"
QUEUE_SOURCE = "culture-religion-parameter-modifier-human-review-batch12"
ORIGIN = "human_confirmed_culture_religion_parameter_modifier_batch12"
MATCH_TYPE_ALREADY_OK = "culture_religion_parameter_modifier_human_confirmed_already_ok"
REVIEWER = "user_human_review_culture_religion_parameter_modifier_batch12"
FOCUS_GROUP = "culture_religion_parameter_modifier_batch12"
...
HOLD_SEGMENT_IDS = {
    21267: "correction hold: wording 'causa ganho de [stress]' needs smoother PT-BR",
}
...
def insert_candidate(conn, run_id: int, context, sample_row: dict[str, Any], timestamp: str) -> int:
    ...
    reasons = [
        "human_confirmed_culture_religion_parameter_modifier_batch12",
    ...
    cursor = conn.execute(
        ...
        (
            ...
            "high_confidence",
            "correct",
            "human-approved culture/religion parameter modifier batch12 already-ok signal",
            REVIEWER,
            timestamp,
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_culture_religion_parameter_modifier_batch12_learning_ingest"
    ...
    lines = [
        "culture/religion parameter modifier batch12 learning ingest",
