...
SEGMENT_IDS = [56619, 56743, 57855, 57865, 58840]
SOURCE = "domain_policy_vote_candidate_token_safe_run522_batch6_canonical_post_validation_v1"
...
def main() -> None:
    ...
    base = reports_dir() / f"{stamp()}_domain_policy_vote_candidate_token_safe_run522_batch6_canonical_post_validation"
