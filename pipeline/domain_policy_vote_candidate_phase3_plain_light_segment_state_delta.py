...
BEFORE_RUN_ID = 531
AFTER_RUN_ID = 532
APPLY_JSONL = Path("reports/20260701_153948_764058_domain_policy_vote_candidate_phase3_plain_light_bridge_materializer_apply.jsonl")
EXPECTED_COUNT = 635
EXPECTED_AFTER_STATE = "closed_auto_confirmed_human_confirmed_misc_equal_output_plain_light_lifecycle"
REPORT_STEM = "domain_policy_vote_candidate_phase3_plain_light_segment_state_delta"
...
def main() -> None:
    ...
    summary = {
        ...
        "policy_bridge": "human_confirmed_misc_equal_output_plain_light_lifecycle_bridge",
        "policy_run_id": 97,
        ...
        "excluded_dynamic_getter": True,
        "excluded_dynamic_select": True,
        "excluded_multiline": True,
    ...
    txt.write_text(
        "\n".join(
            [
                "domain_policy_vote_candidate phase3 plain/light segment-state delta",
