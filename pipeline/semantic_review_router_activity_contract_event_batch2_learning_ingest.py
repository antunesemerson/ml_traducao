...
RULE_VERSION = "semantic_review_router_activity_contract_event_batch2_learning_ingest_v1"
QUEUE_SOURCE = "semantic-review-router-activity-contract-event-human-review-batch2"
ORIGIN = "human_confirmed_semantic_review_router_activity_contract_event_batch2"
...
REVIEWER = "user_human_review_semantic_review_router_activity_contract_event_batch2"
FOCUS_GROUP = "semantic_review_router_activity_contract_event_batch2"
SEGMENT_STATE_RUN_ID = 461
...
APPROVED_CORRECTIONS = {
    46945: "Em suas viagens, você reservará tempo para explorar com calma pequenas cidades e vilarejos, conectando-se com os moradores locais.",
    52459: "de mãos vazias e sem ajuda.\\n\\nEmbora resmungemos, embora nossos olhos cobicem tesouros e bugigangas, nossa estranha peregrinação chegou ao fim.",
    52460: "com metade do pagamento, liderando pequenas companhias arrastadas para longe de suas muralhas.\\n\\nE, assim, os fiéis de nossa estranha peregrinação foram de certa forma recompensados. Pelo menos, mais do que os gregos consternados e desordenados…",
    55909: "Este personagem está desfrutando do apoio popular dos camponeses nas terras por onde viaja.",
    66808: "Eu encaixo uma flecha, levanto o arco e a solto. Com um grito de dor, vejo uma cabra gorda cair, contorcendo-se no chão. Seguem-se balidos em pânico enquanto o caos se espalha entre os animais, seguidos pelas batidas rítmicas dos cascos enquanto os cavaleiros partem em busca da caça.",
    75657: "Não precisamos viajar longe para demonstrar verdadeira devoção. Com uma curta jornada até um santuário próximo e uma oferta sacrificial, poderemos manter o favor divino pelo futuro previsível.",
    101832: "Devido aos meus ferimentos, foi decidido encerrar a caçada e fazer o grupo voltar para casa.",
    101881: "Sem dúvida há um veado robusto na região, e as condições dificilmente poderiam ser melhores para caçá-lo!",
}
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_semantic_review_router_activity_contract_event_batch2_learning_ingest"
    ...
    lines = [
        "semantic review router activity contract event batch2 learning ingest",
