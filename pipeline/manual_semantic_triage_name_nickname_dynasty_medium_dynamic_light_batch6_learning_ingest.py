...
RULE_VERSION = "manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch6_learning_ingest_v1"
QUEUE_SOURCE = "manual-semantic-triage-name-nickname-dynasty-medium-dynamic-light-human-review-batch6"
ORIGIN = "human_confirmed_manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch6"
...
REVIEWER = "user_human_review_manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch6"
FOCUS_GROUP = "manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch6"
SEGMENT_STATE_RUN_ID = 479
...
APPROVED_CORRECTIONS = {
    129924: "Acho que [target.GetFirstName] se importa com o prestígio da própria família",
    164512: "recusou-se a casar em um [GetActivityType('activity_wedding').GetName|l]",
    120819: "Você decide deixar suas ações - em vez de um [epithet|lE] - falarem por si.",
    164201: "[rival.GetName] e eu deixamos nossas mágoas para trás e deixamos de ser rivais",
    164528: "organizou um [GetActivityType('activity_wedding').GetName|l] bem-sucedido",
    103050: "[CHARACTER.GetShortUIName|U] reivindicou um tesouro de ouro encontrado por sua ave de rapina",
    121381: "Você adquiriu este traço porque não conseguiu encontrar sentido na passagem de [sacred_text.GetName]",
}
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch6_learning_ingest"
    ...
    lines = [
        "manual semantic triage name/nickname/dynasty medium dynamic light batch6 learning ingest",
