...
RULE_VERSION = "semantic_plain_lowrisk_batch17_learning_ingest_v1"
QUEUE_SOURCE = "semantic-plain-lowrisk-human-review-batch17"
ORIGIN = "human_confirmed_semantic_plain_lowrisk_batch17"
MATCH_TYPE_ALREADY_OK = "semantic_plain_lowrisk_human_confirmed_already_ok"
MATCH_TYPE_CORRECTION = "semantic_plain_lowrisk_human_correction"
REVIEWER = "user_human_review_semantic_plain_lowrisk_batch17"
FOCUS_GROUP = "semantic_plain_lowrisk_batch17"
...
def insert_candidate(
    ...
    reasons = [
        "human_confirmed_semantic_plain_lowrisk_batch17",
        "no_source_write",
        "no_output_write",
        "approved_in_chat",
    ...
    cursor = conn.execute(
        ...
        (
            ...
            human_label,
            corrected_text,
            "human-approved semantic plain lowrisk batch17 learning signal",
            REVIEWER,
            timestamp,
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_semantic_plain_lowrisk_batch17_learning_ingest"
    ...
    lines = [
        "semantic plain lowrisk batch17 learning ingest",
