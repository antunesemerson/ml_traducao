...
SOURCE = "domain_policy_vote_candidate_religion_faith_clergy_adherent_policy_registry_v1"
AGENT_KEY = "religion_faith_doctrine_clergy_adherent_policy"
...
REVIEW_SUMMARY_PATH = Path(
    "reports/20260630_103720_309140_domain_policy_vote_candidate_religion_faith_clergy_adherent_review_summary.json"
)
REVIEW_JSONL_PATH = Path(
    "reports/20260630_103720_309140_domain_policy_vote_candidate_religion_faith_clergy_adherent_review.jsonl"
)
EXPECTED_REVIEW_COUNT = 23
EXPECTED_SEGMENT_STATE_RUN_ID = 507
EXPECTED_COUNTS = {
    "priest_adherent_runtime_getter": 11,
    "clergy_faithful_multiline_narrative": 5,
    "adherent_variable_achievement_or_requirement": 4,
    "head_of_faith_multiline_requirement": 1,
    "residual_clergy_adherent_context": 1,
    "clergy_faithful_dense_context": 1,
}
...
def planned_record(validation: dict[str, Any], parent_validation: dict[str, Any], priority: int, priority_note: str) -> dict[str, Any]:
    route_subtypes = {
        "priest_adherent_runtime_getter": "route_priest_adherent_getter_role_policy",
        "adherent_variable_achievement_or_requirement": "route_adherent_variable_domain_policy_review",
    }
    hold_subtypes = {
        "clergy_faithful_multiline_narrative": "hold_clergy_faithful_multiline_narrative",
        "head_of_faith_multiline_requirement": "hold_head_of_faith_structural_requirement",
        "clergy_faithful_dense_context": "hold_clergy_faithful_dense_context",
        "residual_clergy_adherent_context": "hold_residual_clergy_adherent_context",
    }
    notes = {
        "source": SOURCE,
        ...
        "hold_family": "clergy_adherent_priest_terms",
        ...
        "policy_recommendation": (
            "Read-only splitter for clergy/adherent surfaces. Route priest/adherent getters and adherent variables "
            "to later parser/policy review; hold narrative multiline, head-of-faith structural, dense, and residual contexts."
        ),
        "guards": {
    ...
    return {
        ...
        "decision_role": DECISION_ROLE,
        "scope_group": SCOPE_GROUP,
        "scope_description": "Read-only splitter for religion_faith_doctrine clergy/adherent/priest term surfaces.",
        "dashboard_group": DASHBOARD_GROUP,
        "priority": priority,
        "notes_json": notes,
    }
...
def write_reports(
    *,
    ...
    lines = [
        "religion_faith_doctrine clergy/adherent policy registry",
        "",
        f"mode: {mode}",
