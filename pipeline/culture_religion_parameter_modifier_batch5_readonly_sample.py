...
RULE_VERSION = "culture_religion_parameter_modifier_batch5_readonly_sample_v1"
...
def write_outputs(
    ...
    base = reports_dir() / f"{stamp()}_culture_religion_parameter_modifier_batch5_readonly_sample"
    ...
    summary = {
        ...
        "recommended_next_step": "review_batch5_with_user_then_ingest_only_confirmed_learning_signals",
    }
    summary_path.write_text(json.dumps(summary, ensure_ascii=False, indent=2, sort_keys=True) + "\n", encoding="utf-8")

    lines = [
        "culture/religion parameter modifier batch5 read-only sample",
