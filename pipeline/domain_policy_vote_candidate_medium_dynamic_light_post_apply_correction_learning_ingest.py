...
RULE_VERSION = "domain_policy_vote_candidate_medium_dynamic_light_post_apply_correction_learning_ingest_v1"
...
APPLY_POST_VALIDATION_PATH = Path("reports/20260629_124044_574723_domain_policy_vote_candidate_medium_dynamic_light_protected_apply_apply_summary.json")
QUEUE_SOURCE = "domain-policy-vote-candidate-medium-dynamic-light-post-apply"
ORIGIN = "human_confirmed_domain_policy_vote_candidate_medium_dynamic_light_post_apply"
MATCH_TYPE_CORRECTION = "domain_policy_vote_candidate_medium_dynamic_light_post_apply_correction"
REVIEWER = "user_human_review_domain_policy_vote_candidate_medium_dynamic_light"
FOCUS_GROUP = "domain_policy_vote_candidate_medium_dynamic_light"
SEGMENT_STATE_RUN_ID = 495
...
def insert_candidate(conn, run_id: int, context, corrected: str, timestamp: str) -> int:
    reasons = [
        RULE_VERSION,
        "domain_policy_vote_candidate_medium_dynamic_light",
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> None:
    base = reports_dir() / f"{stamp()}_domain_policy_vote_candidate_medium_dynamic_light_post_apply_correction_learning_ingest"
    ...
    lines = [
        "domain policy vote candidate medium dynamic light post-apply correction learning ingest",
...
def main() -> None:
    ...
    write_outputs(records, summary, before_snapshot)
