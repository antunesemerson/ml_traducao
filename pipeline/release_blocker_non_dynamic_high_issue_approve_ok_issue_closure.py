...
base.SOURCE = "release_blocker_non_dynamic_high_issue_approve_ok_issue_closure_v1"
base.DEFAULT_INPUT_JSONL = Path("reports/20260703_204522_083421_release_blocker_non_dynamic_high_issue_approve_ok_readiness.jsonl")
base.DEFAULT_SEGMENT_STATE_RUN_ID = 585
base.DEFAULT_LEDGER_RUN_ID = 77
base.EXPECTED_SEGMENT_COUNT = 12
base.TARGET_VALIDATION_STATUS = "closed_resolved_by_human_release_blocker_non_dynamic_high_issue_approve_ok"
