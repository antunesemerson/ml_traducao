...
SOURCE = "domain_policy_vote_candidate_medium_dynamic_light_holds_batch1_segment_state_delta"
FROM_RUN_ID = 502
TO_RUN_ID = 504
SEGMENT_IDS = (
    16845,
...
def fetch_items(conn: sqlite3.Connection, run_id: int, segment_ids: tuple[int, ...]) -> dict[int, dict[str, Any]]:
...
def write_txt(path: Path, summary: dict[str, Any], rows: list[dict[str, Any]]) -> None:
    lines = [
        "medium_dynamic_light holds batch1 segment-state delta",
        "",
