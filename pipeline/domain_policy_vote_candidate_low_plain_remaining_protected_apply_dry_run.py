...
RULE_VERSION = "domain_policy_vote_candidate_low_plain_remaining_protected_apply_dry_run_v1"
...
def write_txt(path: Path, summary: dict[str, Any], records: list[dict[str, Any]]) -> None:
    lines = [
        "domain_policy_vote_candidate low_plain remaining protected apply dry-run",
        "",
...
def main() -> None:
    ...
    base = reports_dir() / f"{stamp()}_domain_policy_vote_candidate_low_plain_remaining_protected_apply_dry_run"
