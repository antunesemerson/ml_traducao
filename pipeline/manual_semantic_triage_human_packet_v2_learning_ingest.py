...
def main() -> None:
    ...
    base.RULE_VERSION = "manual_semantic_triage_human_packet_v2_learning_ingest_v1"
    ...
    base.MATCH_TYPE_ALREADY_OK = "manual_semantic_triage_human_packet_v2_already_ok"
    base.MATCH_TYPE_CORRECTION = "manual_semantic_triage_human_packet_v2_correction"
    base.REVIEWER = "user_human_review_manual_semantic_triage_human_packet_v2"
    base.FOCUS_GROUP = "manual_semantic_triage_human_packet_v2"
