...
RULE_VERSION = "manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch5_learning_ingest_v1"
QUEUE_SOURCE = "manual-semantic-triage-name-nickname-dynasty-medium-dynamic-light-human-review-batch5"
ORIGIN = "human_confirmed_manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch5"
...
REVIEWER = "user_human_review_manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch5"
FOCUS_GROUP = "manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch5"
SEGMENT_STATE_RUN_ID = 478
...
APPROVED_CORRECTIONS = {
    284309: "É tio ou tia de [CHARACTER.GetShortUIName|U]",
    78845: "[local_character_3.GetFirstName] escapa de você",
    164492: "casou-se em um [GetActivityType('activity_wedding').GetName|l]",
    164532: "participou de um [GetActivityType('activity_wedding').GetName|l]",
    62145: "teve sua entrada em uma aliança recusada por [unity_target.GetName]",
}

HELD_SEGMENT_IDS = [163875, 163876, 163882]
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch5_learning_ingest"
    ...
    lines = [
        "manual semantic triage name/nickname/dynasty medium dynamic light batch5 learning ingest",
