...
RULE_VERSION = "culture_religion_parameter_modifier_batch9_learning_ingest_v1"
QUEUE_SOURCE = "culture-religion-parameter-modifier-human-review-batch9"
ORIGIN = "human_confirmed_culture_religion_parameter_modifier_batch9"
MATCH_TYPE_ALREADY_OK = "culture_religion_parameter_modifier_human_confirmed_already_ok"
REVIEWER = "user_human_review_culture_religion_parameter_modifier_batch9"
FOCUS_GROUP = "culture_religion_parameter_modifier_batch9"
...
HOLD_SEGMENT_IDS = {
    21405: "context hold: Han culture phrasing needs smoother PT-BR/context",
    20711: "correction hold: Spanish residual '#high artesana#!'",
    21174: "context hold: province phrase appears incomplete/anglicized",
}
...
def insert_candidate(conn, run_id: int, context, sample_row: dict[str, Any], timestamp: str) -> int:
    ...
    reasons = [
        "human_confirmed_culture_religion_parameter_modifier_batch9",
    ...
    cursor = conn.execute(
        ...
        (
            ...
            "high_confidence",
            "correct",
            "human-approved culture/religion parameter modifier batch9 already-ok signal",
            REVIEWER,
            timestamp,
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_culture_religion_parameter_modifier_batch9_learning_ingest"
    ...
    lines = [
        "culture/religion parameter modifier batch9 learning ingest",
