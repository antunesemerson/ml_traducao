...
def main() -> None:
    ...
    base.RULE_VERSION = "domain_policy_vote_candidate_human_packet_v4_learning_ingest_safe_v1"
    ...
    base.MATCH_TYPE_ALREADY_OK = "domain_policy_vote_candidate_human_packet_v4_already_ok"
    base.MATCH_TYPE_CORRECTION = "domain_policy_vote_candidate_human_packet_v4_correction"
    base.REVIEWER = "user_human_review_domain_policy_vote_candidate_human_packet_v4"
    base.FOCUS_GROUP = "domain_policy_vote_candidate_human_packet_v4"
