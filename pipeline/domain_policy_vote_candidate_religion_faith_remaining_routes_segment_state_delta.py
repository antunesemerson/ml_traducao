...
SOURCE = "domain_policy_vote_candidate_religion_faith_remaining_routes_segment_state_delta"
FROM_RUN_ID = 506
TO_RUN_ID = 507
SEGMENT_IDS = (111890, 38677, 75630, 75631)
...
def main() -> None:
    ...
    lines = [
        "domain_policy_vote_candidate religion faith remaining routes segment-state delta",
        "",
