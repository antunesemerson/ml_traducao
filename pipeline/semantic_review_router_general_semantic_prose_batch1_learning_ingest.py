...
RULE_VERSION = "semantic_review_router_general_semantic_prose_batch1_learning_ingest_v1"
QUEUE_SOURCE = "semantic-review-router-general-semantic-prose-human-review-batch1"
ORIGIN = "human_confirmed_semantic_review_router_general_semantic_prose_batch1"
...
REVIEWER = "user_human_review_semantic_review_router_general_semantic_prose_batch1"
FOCUS_GROUP = "semantic_review_router_general_semantic_prose_batch1"
SEGMENT_STATE_RUN_ID = 467
...
APPROVED_CORRECTIONS = {
    12385: "olho ao redor, tentando localizar o mapa do tesouro, mas rapidamente percebo que ele não está em lugar nenhum.\\n\\nAgora, não tenho como concluir a busca pelo tesouro final...",
    38625: "Somos filhos e filhas dos deuses. Brahman, Vishnu... nosso sangue remonta ao início dos tempos.",
    38631: "Vencedor dos exércitos islâmicos em Orange, Guilherme de Gellone foi um guerreiro da Cristandade e fundou a abadia de Gellone, para onde mais tarde se retiraria do governo e viveria como monge.",
    38645: "É por causa de Scota, filha de um grande faraó egípcio, que chamamos nossa terra de \"Escócia\". Ela é a mãe de todos os escoceses, e é o sangue dos antigos faraós que corre em nossas veias.",
    38647: "Nascidos do ventre de uma deusa dragão e descendentes de Mahasammata, carregamos em nossa linhagem o sangue mais sagrado e poderoso.",
}
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_semantic_review_router_general_semantic_prose_batch1_learning_ingest"
    ...
    lines = [
        "semantic review router general semantic prose batch1 learning ingest",
