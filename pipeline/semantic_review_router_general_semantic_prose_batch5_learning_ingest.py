...
RULE_VERSION = "semantic_review_router_general_semantic_prose_batch5_learning_ingest_v1"
QUEUE_SOURCE = "semantic-review-router-general-semantic-prose-human-review-batch5"
ORIGIN = "human_confirmed_semantic_review_router_general_semantic_prose_batch5"
...
REVIEWER = "user_human_review_semantic_review_router_general_semantic_prose_batch5"
FOCUS_GROUP = "semantic_review_router_general_semantic_prose_batch5"
SEGMENT_STATE_RUN_ID = 471
...
APPROVED_CORRECTIONS = {
    44429: "\\n\\nAs sobrancelhas se franzem enquanto o jogo avança inexoravelmente, e os espectadores mantêm um silêncio absoluto para evitar distrações; ou pior, revelar uma possível jogada que beneficiaria seu favorito.",
    44515: "Eu simplesmente não entendo! Consigo acertar o alvo quando treino. A menos que... olho desconfiado para o meu arco...",
    44868: "Esfaqueado amanhã!\\nVai ser esfaqueado amaaa-nhã!\\nVai ser esfaqueado amanhã!",
    44869: "Vocês não cantam mais\\nVocês não cantam mais\\nVocês não cantam mais!\\nAh, vocês não cantam mais!",
    44885: "Não há tempo a perder: preciso começar a me preparar! Tenho que vencer, custe o que custar!",
    44950: "Receio que minha doença seja grave demais para eu continuar neste torneio. Não terei um bom desempenho neste estado e não devo provocar a ira do médico...",
    45346: "Estou conversando animadamente sobre as próximas competições com alguns participantes quando, de repente, sinto meu estômago revirar e minha respiração se contrair.\\n\\n",
    45348: "Deuses, que fogo é esse dentro de mim! \"A-ajuda!\", gaguejo, enquanto os rostos estúpidos dos meus conhecidos me encaram.",
    45350: "Antes mesmo de me virar, é como se um cavalo me derrubasse com um coice. Uma figura encapuzada me imobiliza, cravando uma adaga rumo ao meu coração!",
    47243: "Após não conseguir atrair interesse significativo, a localização exata da mansão privada foi, ironicamente, perdida. Apenas um incêndio acidental provocado por um grupo de bandidos que a ocupavam permitiu reencontrar suas ruínas.",
    47247: "Parece que a maioria daqueles que desejam treinar o corpo também está em busca de briga com outros que fazem o mesmo. Após uma série de duelos que terminaram em assassinatos, o ginásio sucumbiu a um tumulto que destruiu o prédio.",
}
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_semantic_review_router_general_semantic_prose_batch5_learning_ingest"
    ...
    lines = [
        "semantic review router general semantic prose batch5 learning ingest",
