...
RULE_VERSION = "culture_religion_parameter_modifier_batch2_learning_ingest_v1"
QUEUE_SOURCE = "culture-religion-parameter-modifier-human-review-batch2"
ORIGIN = "human_confirmed_culture_religion_parameter_modifier_batch2"
MATCH_TYPE_ALREADY_OK = "culture_religion_parameter_modifier_law_unlock_human_confirmed_already_ok"
REVIEWER = "user_human_review_culture_religion_parameter_modifier_batch2"
FOCUS_GROUP = "culture_religion_parameter_modifier_batch2"
APPROVED_SEGMENT_IDS = [20289, 20290, 20291, 20292]
...
def insert_candidate(conn, run_id: int, context, sample_row: dict[str, Any], timestamp: str) -> int:
    ...
    reasons = [
        "human_confirmed_culture_religion_parameter_modifier_batch2",
        "law_unlock_pattern_confirmed_from_batch1",
    ...
    cursor = conn.execute(
        ...
        (
            ...
            "high_confidence",
            "correct",
            "human-approved culture/religion law unlock parameter already-ok signal",
            REVIEWER,
            timestamp,
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_culture_religion_parameter_modifier_batch2_learning_ingest"
    ...
    lines = [
        "culture/religion parameter modifier batch2 learning ingest",
...
def main() -> None:
    ...
    summary = {
        ...
        "source_changed": False,
        "output_changed": False,
        "next_action": "apply_local_learning_feedback_for_culture_religion_parameter_modifier_batch2",
    }
