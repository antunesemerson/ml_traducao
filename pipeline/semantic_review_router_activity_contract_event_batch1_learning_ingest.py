...
RULE_VERSION = "semantic_review_router_activity_contract_event_batch1_learning_ingest_v1"
...
REVIEWER = "user_human_review_semantic_review_router_activity_contract_event_batch1"
FOCUS_GROUP = "semantic_review_router_activity_contract_event_batch1"
...
APPROVED_CORRECTIONS = {
    46883: "Há muita inspiração para encontrar na estrada — belas paisagens, pontos turísticos impressionantes e pessoas notáveis para conhecer. Isso realmente mexe com a imaginação!",
}
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_semantic_review_router_activity_contract_event_batch1_learning_ingest"
    ...
    lines = [
        "semantic review router activity contract event batch1 learning ingest",
