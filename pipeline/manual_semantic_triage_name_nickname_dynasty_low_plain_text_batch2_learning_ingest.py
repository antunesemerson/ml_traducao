...
RULE_VERSION = "manual_semantic_triage_name_nickname_dynasty_low_plain_text_batch2_learning_ingest_v1"
QUEUE_SOURCE = "manual-semantic-triage-name-nickname-dynasty-low-plain-text-human-review-batch2"
ORIGIN = "human_confirmed_manual_semantic_triage_name_nickname_dynasty_low_plain_text_batch2"
...
REVIEWER = "user_human_review_manual_semantic_triage_name_nickname_dynasty_low_plain_text_batch2"
FOCUS_GROUP = "manual_semantic_triage_name_nickname_dynasty_low_plain_text_batch2"
SEGMENT_STATE_RUN_ID = 473
...
APPROVED_CORRECTIONS = {
    120837: "Espero que apreciem minha bondade.",
    120881: "Suponho que eu seja uma esp\u00e9cie de historiador...",
    120902: "*Grunhido de aprova\u00e7\u00e3o*",
    120903: "*Grunhido de desaprova\u00e7\u00e3o*",
    153599: "Reverenciado erudito-general do fim da Song do Sul, Wen Tianxiang tornou-se um farol de resist\u00eancia contra a conquista mongol. Capturado ap\u00f3s uma defesa fracassada da dinastia, recusou-se a servir aos Yuan e morreu m\u00e1rtir. Sua poesia composta na pris\u00e3o, especialmente a \"Can\u00e7\u00e3o da Retid\u00e3o\", eternizou seu legado como paradigma de virtude e lealdade.",
}

HELD_SEGMENT_IDS = [112295, 120831, 163598]
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_manual_semantic_triage_name_nickname_dynasty_low_plain_text_batch2_learning_ingest"
    ...
    lines = [
        "manual semantic triage name/nickname/dynasty low plain text batch2 learning ingest",
