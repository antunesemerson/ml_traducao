...
RULE_VERSION = "semantic_review_router_activity_contract_event_batch3_learning_ingest_v1"
QUEUE_SOURCE = "semantic-review-router-activity-contract-event-human-review-batch3"
ORIGIN = "human_confirmed_semantic_review_router_activity_contract_event_batch3"
...
REVIEWER = "user_human_review_semantic_review_router_activity_contract_event_batch3"
FOCUS_GROUP = "semantic_review_router_activity_contract_event_batch3"
SEGMENT_STATE_RUN_ID = 462
...
APPROVED_CORRECTIONS = {
    102040: "Dou uma olhada ao redor sorrateiramente — esta pode ser a melhor oportunidade que terei...",
    102127: "Os batedores logo estarão em posição, prontos para espantar a presa e fazê-la fugir.",
    102959: "esfolando desajeitadamente a carcaça antes de deixar os mestres da caça assumirem.",
    104356: "A embarcação parece flutuar, intocada, acima das ondas violentas, guiada em segurança por alguma força divina através da tempestade.",
    105062: "Um barco pequeno de fundo chato, comum em rios e águas costeiras do sudeste da Ásia. Normalmente feitos de madeira e impulsionados a remo ou com varas, os sampanas são usados para pesca, viagem e comércio fluvial.",
}
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_semantic_review_router_activity_contract_event_batch3_learning_ingest"
    ...
    lines = [
        "semantic review router activity contract event batch3 learning ingest",
