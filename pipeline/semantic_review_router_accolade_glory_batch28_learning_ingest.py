...
RULE_VERSION = "semantic_review_router_accolade_glory_batch28_learning_ingest_v1"
QUEUE_SOURCE = "semantic-review-router-accolade-glory-human-review-batch28"
ORIGIN = "human_confirmed_semantic_review_router_accolade_glory_batch28"
...
REVIEWER = "user_human_review_semantic_review_router_accolade_glory_batch28"
FOCUS_GROUP = "semantic_review_router_accolade_glory_batch28"
SEGMENT_STATE_RUN_ID = 458
...
APPROVED_CORRECTIONS = {
    645: "[acclaimed_knight.GetName] se destacou liderando piqueiros na batalha e pode ser [acclaimed|El] como [GetAccoladeType('pike_attribute').GetName|l]",
    647: "[acclaimed_knight.GetName] se distinguiu liderando a cavalaria leve em batalha e pode ser [acclaimed|El] como [GetAccoladeType('outrider_attribute').GetName|l]",
    41496: "[ROOT.Char.GetSheHe|U] é [acclaimed_knight|El]: $VALUE|=+0$",
}
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_semantic_review_router_accolade_glory_batch28_learning_ingest"
    ...
    lines = [
        "semantic review router accolade glory batch28 learning ingest",
