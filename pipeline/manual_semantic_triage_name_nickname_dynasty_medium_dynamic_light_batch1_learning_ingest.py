...
RULE_VERSION = "manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch1_learning_ingest_v1"
QUEUE_SOURCE = "manual-semantic-triage-name-nickname-dynasty-medium-dynamic-light-human-review-batch1"
ORIGIN = "human_confirmed_manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch1"
...
REVIEWER = "user_human_review_manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch1"
FOCUS_GROUP = "manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch1"
SEGMENT_STATE_RUN_ID = 474
...
APPROVED_CORRECTIONS = {
    222: "Ganhe experi\u00eancia adicional como [GetTrait('tourney_participant').GetName( GetNullCharacter )|l].",
    3956: "Nos sentamos junto \u00e0 \u00e1gua, descansamos os p\u00e9s e ou\u00e7o [special_guest.GetFirstName] soltar um suspiro pesado.",
}
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch1_learning_ingest"
    ...
    lines = [
        "manual semantic triage name/nickname/dynasty medium dynamic light batch1 learning ingest",
