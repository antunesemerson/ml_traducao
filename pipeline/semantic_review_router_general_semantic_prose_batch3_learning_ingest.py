...
RULE_VERSION = "semantic_review_router_general_semantic_prose_batch3_learning_ingest_v1"
QUEUE_SOURCE = "semantic-review-router-general-semantic-prose-human-review-batch3"
ORIGIN = "human_confirmed_semantic_review_router_general_semantic_prose_batch3"
...
REVIEWER = "user_human_review_semantic_review_router_general_semantic_prose_batch3"
FOCUS_GROUP = "semantic_review_router_general_semantic_prose_batch3"
SEGMENT_STATE_RUN_ID = 469
...
APPROVED_CORRECTIONS = {
    40154: "\"Meus experimentos deram fruto. Eis um elixir que impedirá o envelhecimento! Até certo ponto. Por favor, dê uma olhada e talvez até prove.\"\\n\\n",
    40155: "\"Meus experimentos deram frutos. Eis um elixir que devolverá parte do seu vigor perdido! Por favor, dê uma olhada e talvez até prove.\"\\n\\n",
    41572: "Encarreguei meus melhores caçadores de reunir as feras mais poderosas destas terras para meu Nerge. Junte-se a mim nesta conquista!",
    41649: "Revelamos nossos dados ao mesmo tempo, mas logo fica claro que será necessária uma terceira rodada. Pegamos nossos copos de dados para a rodada final, em que o vencedor leva tudo.",
    42717: "Nenhum dos três parece ser um candidato particularmente excepcional: todos são completos desconhecidos para mim e claramente não passam de plebeus em busca de uma chance de fama e fortuna, mas são os únicos disponíveis.",
    42747: "Um nó no estômago, desconhecido até poucos instantes atrás, aperta de forma nauseante, e os murmúrios da multidão se intensificam.",
    43976: "Uma clara divisão foi estabelecida entre as duas equipes, que se enfrentam e se provocam enquanto preparam seus equipamentos e sussurram planos. Cavalos são preparados ao fundo, os corcéis relinchando e bufando. Será um dia de trabalho brutal.\\n\\n",
    44029: "Minha equipe está perdendo, e claramente. Sinto a vitória escapar, lenta mas seguramente. Será necessário um esforço enorme para vencer a partir daqui...",
}
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_semantic_review_router_general_semantic_prose_batch3_learning_ingest"
    ...
    lines = [
        "semantic review router general semantic prose batch3 learning ingest",
