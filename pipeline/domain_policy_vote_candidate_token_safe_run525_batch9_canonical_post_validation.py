...
SEGMENT_IDS = [153662, 165324, 281301]
SOURCE = "domain_policy_vote_candidate_token_safe_run525_batch9_canonical_post_validation_v1"
...
def main() -> None:
    ...
    base = reports_dir() / f"{stamp()}_domain_policy_vote_candidate_token_safe_run525_batch9_canonical_post_validation"
