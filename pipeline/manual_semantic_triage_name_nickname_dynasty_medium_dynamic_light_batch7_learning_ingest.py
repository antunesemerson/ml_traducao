...
RULE_VERSION = "manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch7_learning_ingest_v1"
QUEUE_SOURCE = "manual-semantic-triage-name-nickname-dynasty-medium-dynamic-light-human-review-batch7"
ORIGIN = "human_confirmed_manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch7"
...
REVIEWER = "user_human_review_manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch7"
FOCUS_GROUP = "manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch7"
SEGMENT_STATE_RUN_ID = 480
...
APPROVED_CORRECTIONS = {
    125797: "imaturo e mesquinho por recorrer a táticas tão baixas para difamar o nome de [rival.GetFirstName].",
    120877: "Você não adota um [cognomen|lE], com vergonha de que tal pensamento orgulhoso tenha cruzado sua mente.",
    162131: "Não se converterá voluntariamente para deixar [actor.GetFaith.GetName|l], a menos que seja forçado",
    103178: "[CHARACTER.GetShortUIName|U] exigiu que alguns caçadores furtivos lhe ensinassem seus métodos",
    102817: "Olho para [accomplice.GetFirstName], que assente sombriamente, com a testa franzida de determinação, esperando meu movimento.",
    129895: "[target.GetFirstName] e eu acabamos nos divertindo tanto que dançamos durante quase toda a celebração!",
    127204: "As vistas claras dos cumes das colinas em [meditation_location.GetName] favoreciam a reflexão contemplativa.",
}

HELD_SEGMENT_IDS = [101653, 162872]
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch7_learning_ingest"
    ...
    lines = [
        "manual semantic triage name/nickname/dynasty medium dynamic light batch7 learning ingest",
