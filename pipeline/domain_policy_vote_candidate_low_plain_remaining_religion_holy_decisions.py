...
SOURCE = "domain_policy_vote_candidate_low_plain_remaining_religion_holy_decisions"

DECISIONS: dict[int, tuple[str, str, str]] = {
    38603: ("approve_already_ok", "", "Current PT-BR text is acceptable."),
    238088: ("approve_already_ok", "", "Current PT-BR text is acceptable; veneramos fits ancestral piety context."),
}
...
def write_txt(path: Path, summary: dict[str, Any], rows: list[dict[str, Any]]) -> None:
    lines = [
        "domain_policy_vote_candidate low_plain remaining religion holy decisions",
        "",
