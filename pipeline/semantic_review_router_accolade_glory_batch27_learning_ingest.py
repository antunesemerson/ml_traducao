...
RULE_VERSION = "semantic_review_router_accolade_glory_batch27_learning_ingest_v1"
QUEUE_SOURCE = "semantic-review-router-accolade-glory-human-review-batch27"
ORIGIN = "human_confirmed_semantic_review_router_accolade_glory_batch27"
...
REVIEWER = "user_human_review_semantic_review_router_accolade_glory_batch27"
FOCUS_GROUP = "semantic_review_router_accolade_glory_batch27"
SEGMENT_STATE_RUN_ID = 456
...
APPROVED_CORRECTIONS = {
    209: "Um [acclaimed_knight|lE] veterano está dedicando atenção às levas deste personagem.",
    671: "O [acclaimed_knight|E] não tem o traço [GetTrait('denounced').GetName( GetNullCharacter )|l]",
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_semantic_review_router_accolade_glory_batch27_learning_ingest"
    ...
    lines = [
        "semantic review router accolade glory batch27 learning ingest",
