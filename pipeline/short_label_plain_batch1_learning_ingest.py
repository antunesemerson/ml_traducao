...
RULE_VERSION = "short_label_plain_batch1_learning_ingest_v1"
QUEUE_SOURCE = "short-label-plain-human-review-batch1"
ORIGIN = "human_confirmed_short_label_plain_batch1"
...
REVIEWER = "user_human_review_short_label_plain_batch1"
FOCUS_GROUP = "short_label_plain_batch1"

APPROVED_DECISIONS = {
    701: ("already_ok", None),
    23482: ("human_correction_candidate", "maltrapilho"),
    25201: ("already_ok", None),
    34795: ("already_ok", None),
    35879: ("human_correction_candidate", "Requintada"),
    37937: ("already_ok", None),
    38374: ("already_ok", None),
    47168: ("human_correction_candidate", "Que mentiras claramente indecentes."),
    47270: ("human_correction_candidate", "Comece a aplaudir educadamente para interrompê-lo."),
    48640: ("already_ok", None),
    48641: ("already_ok", None),
}
...
def insert_candidate(conn, run_id: int, context, packet_row: dict[str, Any], suggested: str, match_type: str, timestamp: str) -> int:
    reasons = [
        "human_confirmed_short_label_plain_batch1",
    ...
    cursor = conn.execute(
        ...
        (
            ...
            "high_confidence",
            "correct",
            "human-approved short label plain batch1 learning signal",
            REVIEWER,
            timestamp,
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_short_label_plain_batch1_learning_ingest"
    ...
    lines = [
        "short label plain batch1 learning ingest",
...
def main() -> None:
    ...
    summary = {
        ...
        "next_action": "apply_local_learning_feedback_for_short_label_plain_batch1",
    }
