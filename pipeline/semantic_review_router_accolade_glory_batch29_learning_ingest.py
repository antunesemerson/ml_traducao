...
RULE_VERSION = "semantic_review_router_accolade_glory_batch29_learning_ingest_v1"
QUEUE_SOURCE = "semantic-review-router-accolade-glory-human-review-batch29"
ORIGIN = "human_confirmed_semantic_review_router_accolade_glory_batch29"
MATCH_TYPE_ALREADY_OK = "semantic_review_router_accolade_glory_human_confirmed_already_ok"
MATCH_TYPE_CORRECTION = "semantic_review_router_accolade_glory_human_correction"
REVIEWER = "user_human_review_semantic_review_router_accolade_glory_batch29"
FOCUS_GROUP = "semantic_review_router_accolade_glory_batch29"
SEGMENT_STATE_RUN_ID = 459
...
APPROVED_CORRECTIONS = {
    98594: "[changing_accolade.GetNameNoTooltip] agora é [acclaimed_knight.Custom('AccoladeRankFlavorNumber')]\\nApenas o tempo dirá se [acclaimed_knight.GetShortUINameNoTooltip] pode reconquistar o antigo prestígio do título.",
    98598: "[changing_accolade.GetNameNoTooltip] agora é [acclaimed_knight.Custom('AccoladeRankFlavorNumber')], perdendo todos os seus efeitos\\nApenas o tempo dirá se [acclaimed_knight.GetShortUINameNoTooltip] pode reconquistar o antigo prestígio do título.",
    286563: "Agora você pode criar este [accolade|lE] se desejar.\\n\\nMais galardões ficarão disponíveis conforme a sua [culture|lE] descobrir [innovations|lE].",
}
...
def insert_candidate(conn, run_id: int, context, suggested: str, match_type: str, source_language: str, reason: str, timestamp: str) -> int:
    reasons = [
        RULE_VERSION,
        "semantic_review_router_accolade_glory",
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_semantic_review_router_accolade_glory_batch29_learning_ingest"
    ...
    lines = [
        "semantic review router accolade glory batch29 learning ingest",
            ...
            if not reasons:
                ...
                if existing:
                    ...
                    candidate_id = insert_candidate(
                        ...
                        "human_already_ok",
                        "human-approved semantic review router accolade glory already-ok signal",
                        timestamp,
                    )
                    inserted += 1
                    inserted_ok += 1
            ...
            if not reasons:
                ...
                if existing:
                    ...
                    candidate_id = insert_candidate(
                        ...
                        "human_correction",
                        "human-approved semantic review router accolade glory correction",
                        timestamp,
                    )
                    inserted += 1
