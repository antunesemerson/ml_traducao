...
RULE_VERSION = "manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch4_learning_ingest_v1"
QUEUE_SOURCE = "manual-semantic-triage-name-nickname-dynasty-medium-dynamic-light-human-review-batch4"
ORIGIN = "human_confirmed_manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch4"
...
REVIEWER = "user_human_review_manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch4"
FOCUS_GROUP = "manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch4"
SEGMENT_STATE_RUN_ID = 477
...
APPROVED_CORRECTIONS = {
    50030: "Você detém o [GetTitleByKey('e_latin_empire').GetName]",
    50977: "enquanto [third_place_charioteer.GetFirstName] acossa impacientemente, pressionando por uma oportunidade de ultrapassar.",
    51044: "Custo base de [GetActivityType( 'activity_chariot_race' ).GetName|l]",
    54860: "\\n\\n[visiting_partner.GetFirstName] estala os nós dos dedos e me olha, assentindo discretamente na direção dos suprimentos, e murmura: \"Quer causar uma distração...?\".",
}
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch4_learning_ingest"
    ...
    lines = [
        "manual semantic triage name/nickname/dynasty medium dynamic light batch4 learning ingest",
