...
RULE_VERSION = "culture_religion_parameter_modifier_batch10_learning_ingest_v1"
QUEUE_SOURCE = "culture-religion-parameter-modifier-human-review-batch10"
ORIGIN = "human_confirmed_culture_religion_parameter_modifier_batch10"
MATCH_TYPE_ALREADY_OK = "culture_religion_parameter_modifier_human_confirmed_already_ok"
REVIEWER = "user_human_review_culture_religion_parameter_modifier_batch10"
FOCUS_GROUP = "culture_religion_parameter_modifier_batch10"
...
HOLD_SEGMENT_IDS = {
    20651: "correction hold: missing comma after [barony|lE]",
    20652: "correction hold: missing comma after [county|lE]",
    20654: "style hold: standardize tier wording with surrounding series",
    20656: "style hold: standardize tier wording with surrounding series",
    20706: "correction hold: weak/residual #high arma#! wording",
}
...
def insert_candidate(conn, run_id: int, context, sample_row: dict[str, Any], timestamp: str) -> int:
    ...
    reasons = [
        "human_confirmed_culture_religion_parameter_modifier_batch10",
    ...
    cursor = conn.execute(
        ...
        (
            ...
            "high_confidence",
            "correct",
            "human-approved culture/religion parameter modifier batch10 already-ok signal",
            REVIEWER,
            timestamp,
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_culture_religion_parameter_modifier_batch10_learning_ingest"
    ...
    lines = [
        "culture/religion parameter modifier batch10 learning ingest",
...
def main() -> None:
    ...
    summary = {
        ...
        "next_action": "apply_local_learning_feedback_then_self_service_lifecycle_policy_materializer",
    }
