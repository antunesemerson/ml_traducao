...
RULE_VERSION = "manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch2_learning_ingest_v1"
QUEUE_SOURCE = "manual-semantic-triage-name-nickname-dynasty-medium-dynamic-light-human-review-batch2"
ORIGIN = "human_confirmed_manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch2"
...
REVIEWER = "user_human_review_manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch2"
FOCUS_GROUP = "manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch2"
SEGMENT_STATE_RUN_ID = 475
...
APPROVED_CORRECTIONS = {
    29450: "Experiente em [GetTrait('tourney_participant').GetName( GetNullCharacter )]",
    29451: "Experiente em [GetTrait('lifestyle_reveler').GetName( GetNullCharacter )]",
    29453: "Experiente em [GetTrait('lifestyle_hunter').GetName( GetNullCharacter )]",
    29454: "Experiente em [GetTrait('lifestyle_blademaster').GetName( GetNullCharacter )]",
    29456: "Experiente em [GetTrait('lifestyle_physician').GetName( GetNullCharacter )]",
    29457: "Experiente em [GetTrait('lifestyle_herbalist').GetName( GetNullCharacter )]",
    33085: "[GetActivityType('activity_adult_education').GetName] conclu\u00edda",
    33111: "[GetActivityType('activity_adult_education').GetName] interrompida por pris\u00e3o",
    33115: "[GetActivityType('activity_adult_education').GetName] conclu\u00edda",
}

HELD_SEGMENT_IDS = [12106]
...
def write_outputs(records: list[dict[str, Any]], summary: dict[str, Any], before_snapshot: dict[str, Any]) -> tuple[Path, Path, Path, Path]:
    base = reports_dir() / f"{stamp()}_manual_semantic_triage_name_nickname_dynasty_medium_dynamic_light_batch2_learning_ingest"
    ...
    lines = [
        "manual semantic triage name/nickname/dynasty medium dynamic light batch2 learning ingest",
