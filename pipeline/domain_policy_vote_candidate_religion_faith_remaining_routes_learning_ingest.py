...
DECISIONS_PATH = Path("reports/20260630_092216_687689_domain_policy_vote_candidate_religion_faith_remaining_routes_decisions.jsonl")
...
def main() -> None:
    ...
    base.RULE_VERSION = "domain_policy_vote_candidate_religion_faith_remaining_routes_learning_ingest_v1"
    base.QUEUE_SOURCE = "domain-policy-vote-candidate-religion-faith-remaining-routes"
    base.ORIGIN = "human_confirmed_domain_policy_vote_candidate_religion_faith_remaining_routes"
    base.MATCH_TYPE_ALREADY_OK = "domain_policy_vote_candidate_religion_faith_remaining_routes_already_ok"
    base.MATCH_TYPE_CORRECTION = "domain_policy_vote_candidate_religion_faith_remaining_routes_correction"
