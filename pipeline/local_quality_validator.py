...
SORTED_SPANISH_RESIDUE_PHRASES = tuple(sorted(SPANISH_RESIDUE_PHRASES))
SORTED_SPANISH_RESIDUE_WORDS = tuple(sorted(SPANISH_RESIDUE_WORDS))
...
NEUTRAL_WORD_GENDER_TOKEN_PATTERN = re.compile(
    r"\b(?:inexperiente|inteligente|competente|paciente|obediente|prudente|brilhante|viajante)"
