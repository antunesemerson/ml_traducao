...
SOURCE = "domain_policy_vote_candidate_token_safe_run525_batch9_decisions_v1"
...
SEGMENT_STATE_RUN_ID = 525
APPROVED_SEGMENT_IDS = {153662, 165324, 281301}
...
def main() -> None:
        ...
        decisions.append(
            {
                ...
                "change_family": "token_safe_text_replacement_batch9",
                "human_decision": "approve_correction",
                "human_review_status": "approved",
                "decision_source": "chat_human_approval",
                "decision_note": "Approved by user for protected apply dry-run; final token-safe package items.",
    ...
    base = reports_dir() / f"{stamp()}_domain_policy_vote_candidate_token_safe_run525_batch9_decisions"
